...
public partial class CameraDetectionValidator
{
    ...
    {
        < 0 => throw new ArgumentOutOfRangeException("Camera ID must be >= 0", nameof(cameraId)),
    ...
    [GeneratedRegex(@"^[A-Z]{1,2}-\d{2,4}[A-Z]{1,2}$")]
