...
public class DemoDataWriter(CccDataContext context, DemoDataGenerator generator)
{
    private readonly CccDataContext context = context;
    private readonly DemoDataGenerator generator = generator;
    ...
    {
        await context.Detections.ExecuteDeleteAsync();
        await context.Payments.ExecuteDeleteAsync();
        await context.Cars.ExecuteDeleteAsync();
        await context.Owners.ExecuteDeleteAsync();
    }
